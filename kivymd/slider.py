...
<MDSliderRed>:
    ...
    canvas:
        ...
        Color:
            rgba: [0,0,0,0] if self._is_off \
                else ([1,0,0,1] if not self.disabled else self._track_color_disabled)
        Rectangle:
            size:     ((self.width-self.padding*2)*self.value_normalized, sp(4)) \
                if slider.orientation == 'horizontal' else (sp(4), (self.height-self.padding*2)*self.value_normalized)
            pos:    (self.x + self.padding, self.center_y - dp(4)) if self.orientation == 'horizontal' \
...
<MDSliderGreen>:
    ...
    canvas:
        ...
        Color:
            rgba: [0,0,0,0] if self._is_off \
                else ([0,1,0,1] if not self.disabled else self._track_color_disabled)
        Rectangle:
            size:     ((self.width-self.padding*2)*self.value_normalized, sp(4)) \
                if slider.orientation == 'horizontal' else (sp(4), (self.height-self.padding*2)*self.value_normalized)
            pos:    (self.x + self.padding, self.center_y - dp(4)) if self.orientation == 'horizontal' \
...
<MDSliderBlue>:
    ...
    canvas:
        ...
        Color:
            rgba: [0,0,0,0] if self._is_off \
                else ([0,0,1,1] if not self.disabled else self._track_color_disabled)
        Rectangle:
            size:     ((self.width-self.padding*2)*self.value_normalized, sp(4)) \
                if slider.orientation == 'horizontal' else (sp(4), (self.height-self.padding*2)*self.value_normalized)
            pos:    (self.x + self.padding, self.center_y - dp(4)) if self.orientation == 'horizontal' \
...
class MDSliderRed(ThemableBehavior, Slider):
    # If the slider is clicked
    active = BooleanProperty(False)
    ...
    def __init__(self, **kwargs):
        super(MDSliderRed, self).__init__(**kwargs)
        self.theme_cls.bind(theme_style=self._set_colors,
                            primary_color=self._set_colors,
                            primary_palette=self._set_colors)
        self._set_colors()
    ...
    def on_touch_down(self, touch):
        if super(MDSliderRed, self).on_touch_down(touch):
            self.active = True

    def on_touch_up(self, touch):
        if super(MDSliderRed, self).on_touch_up(touch):
            self.active = False
...
class MDSliderGreen(ThemableBehavior, Slider):
    # If the slider is clicked
    active = BooleanProperty(False)
    ...
    def __init__(self, **kwargs):
        super(MDSliderGreen, self).__init__(**kwargs)
        self.theme_cls.bind(theme_style=self._set_colors,
                            primary_color=self._set_colors,
                            primary_palette=self._set_colors)
        self._set_colors()
    ...
    def on_touch_down(self, touch):
        if super(MDSliderGreen, self).on_touch_down(touch):
            self.active = True

    def on_touch_up(self, touch):
        if super(MDSliderGreen, self).on_touch_up(touch):
            self.active = False
...
class MDSliderBlue(ThemableBehavior, Slider):
    # If the slider is clicked
    active = BooleanProperty(False)
    ...
    def __init__(self, **kwargs):
        super(MDSliderBlue, self).__init__(**kwargs)
        self.theme_cls.bind(theme_style=self._set_colors,
                            primary_color=self._set_colors,
                            primary_palette=self._set_colors)
        self._set_colors()
    ...
    def on_touch_down(self, touch):
        if super(MDSliderBlue, self).on_touch_down(touch):
            self.active = True

    def on_touch_up(self, touch):
        if super(MDSliderBlue, self).on_touch_up(touch):
            self.active = False
